  ...
  return (
    <div className="bg-gradient-to-br from-purple-500 via-indigo-500 to-blue-500 rounded-2xl p-6 text-white">
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-purple-100 text-sm font-medium mb-1">월간 회고 현황</p>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-purple-100">완료율</span>
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="bg-white/10 rounded-xl p-3 text-center backdrop-blur-sm">
          ...
          <p className="text-xs text-purple-100">전체</p>
        </div>
        <div className="bg-white/10 rounded-xl p-3 text-center backdrop-blur-sm">
        ...
        <div className="bg-white/10 rounded-xl p-3 text-center backdrop-blur-sm">
          ...
          <p className="text-xs text-purple-100">진행 중</p>
        </div>
        <div className="bg-white/10 rounded-xl p-3 text-center backdrop-blur-sm">
          <p className="text-2xl font-bold">{statistics.notStarted}</p>
          <p className="text-xs text-purple-100">미시작</p>
        </div>
      </div>
    </div>
  );
