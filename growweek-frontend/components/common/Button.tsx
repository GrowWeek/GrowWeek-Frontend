...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  outline:
    "bg-transparent border border-zinc-300 text-zinc-700 hover:bg-zinc-50 focus:ring-zinc-500 dark:border-zinc-600 dark:text-zinc-300 dark:hover:bg-zinc-800",
};
